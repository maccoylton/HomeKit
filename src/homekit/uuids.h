...
/* David B Brown - converting to latest homekit spec */
#define HOMEKIT_SERVICE_PAIRING	              0x0055
#define HOMEKIT_SERVICE_ACCESSORY_INFORMATION 0x003E
#define HOMEKIT_SERVICE_PROTOCOL_INFORMATION  0x00A2
